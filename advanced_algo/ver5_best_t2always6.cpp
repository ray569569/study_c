...
// DynamicEndpointPathFinder: EnhancedPathFinder with dynamic endpoint protection
class DynamicEndpointPathFinder {
...
public:
    ...
    void solve() {
        ...
        cout << "=== Dynamic Endpoint PathFinder ===" << endl;
        ...
        // Phase 1: Initial routing (no overlaps)
...
int main(int argc, char* argv[]) {
    ...
    DynamicEndpointPathFinder router;
    router.init(W, H);
